...
public class Runner2019 extends Runner {
    public static AocProblem[] allDays = new AocProblem[] { new y2019.day1.Part1("input/2019/day1/puzzle.txt", 3279287),
            ...
            new y2019.day10.Part2("input/2019/day10/puzzle.txt", 829),
            new y2019.day11.Part1("input/2019/day11/puzzle.txt", 1885),
            new y2019.day11.Part2("input/2019/day11/puzzle.txt", "BFEAGHAF"),
            new y2019.day12.Part1("input/2019/day12/puzzle.txt", 7077),
            new y2019.day12.Part2("input/2019/day12/puzzle.txt", 402951477454512L),
            new y2019.day13.Part1("input/2019/day13/puzzle.txt", 251),
            new y2019.day13.Part2("input/2019/day13/puzzle.txt", 12779),
            new y2019.day14.Part1("input/2019/day14/puzzle.txt", 136771),
            ...
            new y2019.day17.Part1("input/2019/day17/puzzle.txt", 8928),
            new y2019.day17.Part2("input/2019/day17/puzzle.txt", 880360),
            new y2019.day18.Part1("input/2019/day18/puzzle.txt", 3048) };

    public static void main(String[] args) {
        var runner = new Runner2018();

        // var allDays = new AocProblem[] { new y2019.day18.Part1("input/2019/day18/puzzle.txt", 3048) };
