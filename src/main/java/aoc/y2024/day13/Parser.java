    ...
    public List<MachineData> parse(List<String> lines) {
        ...
        for (var line : lines) {
            ...
            if ("".equals(line.trim())) {
                ...
                var buttonData = new Point(Integer.parseInt(buttonMatcher.group(2)), Integer.parseInt(buttonMatcher.group(3)));
                ...
                prize = new Point(Integer.parseInt(prizeMatcher.group(1)), Integer.parseInt(prizeMatcher.group(2)));
            } else {
